...
See [REFERENCE.md](REFERENCE.md) for full phase instructions and loop construction
patterns. (The original HITL script and MJE-specific examples have been removed;
adapt the patterns to the album-review static-web-app context.)
