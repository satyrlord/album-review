...
Consult the relevant format file whenever creating or revising one of these artifacts:
...
- `MISSION.md`: A document capturing the _reason_ the user is interested in the topic. This should be used to ground all teaching.
  When creating or revising the mission, use [MISSION-FORMAT.md](./MISSION-FORMAT.md).
...
- `RESOURCES.md`: A list of resources which can be explored to ground your teaching in contextual knowledge, or to acquire knowledge
  and wisdom. When adding or updating resources, use [RESOURCES-FORMAT.md](./RESOURCES-FORMAT.md).
- `./learning-records/*.md`: A directory of learning records, which capture what the user has learned. These are loosely equivalent to
  ...
  `0001-<dash-case-name>.md`, where the number increments each time. When recording a new insight, demonstrated understanding,
  or corrected misconception, use [LEARNING-RECORD-FORMAT.md](./LEARNING-RECORD-FORMAT.md).
...
See [REFERENCE.md](REFERENCE.md) for the pedagogical model — Knowledge,
Skills, Wisdom, and the distinction between fluency and storage strength.
